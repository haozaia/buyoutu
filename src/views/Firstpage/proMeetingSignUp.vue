          ...
          <div class="query-result">
            ...
            <div class="table-wrapper">
              <el-table stripe :data="tableData" style="width: 100%">
                <el-table-column prop="collectCompany" label="往来单位"></el-table-column>
...
<script>
import select1 from "./proMeetingSignUpDialog.vue";
export default {

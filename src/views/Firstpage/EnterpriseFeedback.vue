  ...
  <div id="proVisit">
    <div id="C_content">
      <div class="C_container">
        <div class="C_title">
          <span class="Title_left"></span>企业反馈
        </div>
          ...
          <div class="query-result">
            ...
            <div class="table-wrapper">
              <el-table stripe :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="followResult" label="跟进结果" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="followRecord" label="跟进记录" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="inspectionTime" label="考察时间" :show-overflow-tooltip="true">
                   <template
                    slot-scope="{row}"
                  >{{ row.inspectionTime?row.inspectionTime.slice(0,10):''}}</template>
                </el-table-column>
                <el-table-column prop="followStatus" label="是否放弃" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="giveUpReason" label="放弃原因" :show-overflow-tooltip="true"></el-table-column>
                ...
                <el-table-column prop="inputerName" label="操作" width="150">
...
<script>
import select1 from "./EnterpriseFeedbackDialog.vue";
...
export default {
  ...
  methods: {
    ...
    GovernmentinfoList() {
      ...
      this.axios({
        url: this.api.projectInspectlist,
        method: "post",
        data: this.$qs.stringify(params),
        headers: {
          "Content-Type": "application/x-www-form-urlencoded"

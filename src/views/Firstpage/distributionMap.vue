<template>
  <div id="C_content" class="distributionMap">
    <div class="C_title distributionMapTitle">
     <span class="Title_left"></span>行业统计
      <el-form ref="form" label-width="100px" style="display:inline-block;">
        <el-form-item label="行业：" style="margin:0">
          ...
          <el-date-picker
            ...
            placeholder="开始年份"
          ></el-date-picker>
          <span class="FT400 fontSize20" > 年 - </span>
          <el-date-picker
            v-model="enddate"
            @change="dataTime"
            type="year"
          ...
          ></el-date-picker>
           <span class="FT400 fontSize20" > 年  &nbsp; </span>
            <!-- <el-button class="floatR" @click="showFullScreen('mapTab')" type="primary">全屏</el-button> -->
        </el-form-item>
      </el-form>
    </div>
    ...
    <div class="el-tab" id="mapTab">
      <div class="distributionMapWapper" style="height:80vh;">
        <div class="echartsPat" :style="{height:'80vh',width:'100%'}" id="distributionMap" ref="distributionMap"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    $(window).resize(function() {
      if ($('.distributionMapWapper').width() == 1614) {
        self.checkFull()
      }
    });
  },
  ...
  methods: {
    ...
    launchFullscreen(element) {
      ...
      const len = self.chain.length
         let i = 1
       this.distribuTimer = setInterval(() => {
          if(i<len){
    ...
    drawChinaMap() {
      ...
      let myChart = this.$echarts.init(document.getElementById("distributionMap"));
      var options = {};
      ...
      var colors = [
         ["#1DE9B6", "#F46E36", "#04B9FF", "#5DBD32", "#FFC809", "#FB95D5", "#BDA29A", "#6E7074", "#546570", "#C4CCD3","#1DE9B6", "#F46E36", "#04B9FF", "#5DBD32", "#FFC809", "#FB95D5", "#BDA29A", "#6E7074", "#546570", "#C4CCD3","#1DE9B6", "#F46E36", "#04B9FF", "#5DBD32", "#FFC809", "#FB95D5", "#BDA29A", "#6E7074", "#546570", "#C4CCD3","#1DE9B6", "#F46E36", "#04B9FF", "#5DBD32", "#FFC809", "#FB95D5", "#BDA29A", "#6E7074", "#546570", "#C4CCD3","#1DE9B6", "#F46E36", "#04B9FF", "#5DBD32", "#FFC809", "#FB95D5", "#BDA29A", "#6E7074", "#546570", "#C4CCD3",],
        [
          "#37A2DA",
          "#67E0E3",
          "#32C5E9",
      ...
      document.getElementById("distributionMap").removeAttribute("_echarts_instance_");

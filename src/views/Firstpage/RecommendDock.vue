  ...
  <div id="proVisit">
    <div id="C_content">
      <div class="C_container">
        <div class="C_title">
          <span class="Title_left"></span>已推荐已对接
          ...
          <div class="query-result">
            ...
            <div class="table-wrapper">
              <el-table stripe :data="tableData" style="width: 100%">
                <el-table-column prop="goverment" label="政府名称" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="belongToProject" label="项目名称" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column prop="collectCompany" label="往来单位" :show-overflow-tooltip="true">
                 ...
                 <el-table-column prop="buttEndTime" label="推荐时间" width="180">
                  <template slot-scope="{row}">{{ row.buttEndTime?row.buttEndTime.slice(0,10):''}}</template>
                </el-table-column>
                <el-table-column prop="userName" label="开发人员" :show-overflow-tooltip="true"></el-table-column>

...
<div id="fortuneFv">
  <div id="C_content">
    <div class="C_title"><span class="Title_left"></span>上海民营100强企业名单<!-- 导出按钮 -->
      ...
      <div class="query-result">
        ...
        <template>
          ...
          <el-table :data="qiyelist" stripe style="width: 100%">
            ...
            <el-table-column prop="hangye" label="所属行业" align="center">
              <template slot-scope="{row}">
                {{ row.hangye || '-' }}
              </template>
            </el-table-column>
            <el-table-column prop="yangshou" label="注册资本(万元)" align="center"></el-table-column>
          </el-table>
          </div>

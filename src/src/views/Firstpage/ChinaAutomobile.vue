<template>
  <div id="ChinaAutomobile">
    <div id="C_content">
      <div class="C_title"><span class="Title_left"></span>中国汽车零部件企业百强<!-- 导出按钮 -->
          ...
          <div class="query-result">
            <template>
              ...
              <el-table stripe :data="tableData" v-loading="loading" style="width: 100%">
                ...
                <el-table-column prop="suoshusf" label="省份" width="200" align="center"></el-table-column>

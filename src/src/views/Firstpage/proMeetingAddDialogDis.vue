  ...
  methods: {
    ...
    fiveInfo() {
      ...
      this.axios({
        ...
        datas.belongToIndustry = datas.belongToIndustry?JSON.parse(datas.belongToIndustry):'';
        datas.secondIntentionArea = datas.secondIntentionArea?JSON.parse(datas.secondIntentionArea):'';
        datas.firstIntentionArea = datas.firstIntentionArea?JSON.parse(datas.firstIntentionArea):'';
        datas.contactGoverment = datas.contactGoverment?JSON.parse(datas.contactGoverment):'';
        datas.withoutRegardArea = datas.withoutRegardArea?JSON.parse(datas.withoutRegardArea):'';
        datas.isEnvironmental = datas.isEnvironmental?datas.isEnvironmental.toString():'';
      });
    },
    //地域控制3条
    diyuChange(val) {
